...
print("Welcome to the country happiness predictor! Type in from 0-1 how you feel your country rates.")
type_expectancy = input("How do you rate the life expectancy of your country: ")
type_generosity = input("Rate your countries generosity: ")
type_corruption = input("Rate your countries perception of corruption: ")
